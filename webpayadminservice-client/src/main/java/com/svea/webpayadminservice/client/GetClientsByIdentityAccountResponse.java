...
public class GetClientsByIdentityAccountResponse {

    @XmlElement(name = "GetClientsByIdentityAccountResult", namespace = "http://tempuri.org/", nillable = true)
    protected GetClientsByIdentityAccountResponse2 getClientsByIdentityAccountResult;
     ...
     * @return
     *     possible object is
     *     {@link GetClientsByIdentityAccountResponse2 }
     *     
     */
    public GetClientsByIdentityAccountResponse2 getGetClientsByIdentityAccountResult() {
     ...
     *     
     */
    public void setGetClientsByIdentityAccountResult(GetClientsByIdentityAccountResponse2 value) {
