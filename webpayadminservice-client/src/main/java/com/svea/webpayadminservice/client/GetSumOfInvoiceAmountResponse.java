...
@XmlRootElement(name = "GetSumOfInvoiceAmountResponse", namespace = "http://tempuri.org/")
public class GetSumOfInvoiceAmountResponse {

    @XmlElement(name = "GetSumOfInvoiceAmountResult", namespace = "http://tempuri.org/", nillable = true)
