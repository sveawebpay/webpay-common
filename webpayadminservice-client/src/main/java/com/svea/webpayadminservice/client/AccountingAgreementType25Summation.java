...
/**
 * <p>Java class for AccountingAgreementType25Summation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AccountingAgreementType25Summation"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AccountingAgreementType25Summation", propOrder = {
    "clientId",
    "credit",
    "debit",
    "description",
...
public class AccountingAgreementType25Summation {

    @XmlElement(name = "ClientId")
    protected Long clientId;
    @XmlElement(name = "Credit", nillable = true)
    protected BigDecimal credit;
    @XmlElement(name = "Debit", nillable = true)
