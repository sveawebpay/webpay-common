...
public class UpdateOrderResponse2 {

    @XmlElement(name = "UpdateOrderResult", namespace = "http://tempuri.org/", nillable = true)
    protected UpdateOrderResponse updateOrderResult;
     ...
     * @return
     *     possible object is
     *     {@link UpdateOrderResponse }
     *     
     */
    public UpdateOrderResponse getUpdateOrderResult() {
     ...
     *     
     */
    public void setUpdateOrderResult(UpdateOrderResponse value) {
