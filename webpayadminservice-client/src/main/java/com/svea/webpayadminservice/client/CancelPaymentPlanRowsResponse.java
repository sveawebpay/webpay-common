...
public class CancelPaymentPlanRowsResponse {

    @XmlElement(name = "CancelPaymentPlanRowsResult", namespace = "http://tempuri.org/", nillable = true)
    protected CancelPaymentPlanRowsResponse2 cancelPaymentPlanRowsResult;
     ...
     * @return
     *     possible object is
     *     {@link CancelPaymentPlanRowsResponse2 }
     *     
     */
    public CancelPaymentPlanRowsResponse2 getCancelPaymentPlanRowsResult() {
     ...
     *     
     */
    public void setCancelPaymentPlanRowsResult(CancelPaymentPlanRowsResponse2 value) {
