...
public class ApproveInvoiceResponse2 {

    @XmlElement(name = "ApproveInvoiceResult", namespace = "http://tempuri.org/", nillable = true)
    protected ApproveInvoiceResponse approveInvoiceResult;
     ...
     * @return
     *     possible object is
     *     {@link ApproveInvoiceResponse }
     *     
     */
    public ApproveInvoiceResponse getApproveInvoiceResult() {
     ...
     *     
     */
    public void setApproveInvoiceResult(ApproveInvoiceResponse value) {
