...
public class UpdateOrderRowsResponse2 {

    @XmlElement(name = "UpdateOrderRowsResult", namespace = "http://tempuri.org/", nillable = true)
    protected UpdateOrderRowsResponse updateOrderRowsResult;
     ...
     * @return
     *     possible object is
     *     {@link UpdateOrderRowsResponse }
     *     
     */
    public UpdateOrderRowsResponse getUpdateOrderRowsResult() {
     ...
     *     
     */
    public void setUpdateOrderRowsResult(UpdateOrderRowsResponse value) {
