...
public class CancelPaymentPlanAmountResponse {

    @XmlElement(name = "CancelPaymentPlanAmountResult", namespace = "http://tempuri.org/", nillable = true)
    protected CancelPaymentPlanAmountResponse2 cancelPaymentPlanAmountResult;
     ...
     * @return
     *     possible object is
     *     {@link CancelPaymentPlanAmountResponse2 }
     *     
     */
    public CancelPaymentPlanAmountResponse2 getCancelPaymentPlanAmountResult() {
     ...
     *     
     */
    public void setCancelPaymentPlanAmountResult(CancelPaymentPlanAmountResponse2 value) {
